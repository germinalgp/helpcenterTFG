...
class maxChart {
   ...
   function drawVertical(){
      ...
      foreach ($this->data as $key=>$value) {
	     ...
	     echo '    <div><img src="style/images/bar'.$color.'.png" style="width:'.$barw.'px; height:'.$a.'px;" alt="no imagen" /></div>'."\r\n";
   ...
   function drawHorizontal(){
      ...
      foreach ($this->data as $key=>$value) {
         ...
         echo '    <div class="barhimage"><img src="style/images/barh'.$color.'.png" style="width:'.$b.'px; height:'.$barh.'px;" alt="no imagen" /></div>'."\r\n";
